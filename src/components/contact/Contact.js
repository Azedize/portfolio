  ...
  const sendEmail = (e) => {
    ...
    if (username === "") {
      ...
      setSuccessMsg(
        ...
        emailjs
          .sendForm('service_wmks8rj', 'template_0mqefzt', form.current, '1lXPbg1BUpFGk6hrv',
          )
          .then(
            () => {
              console.log('SUCCESS!');
      ...
      <div className="w-full">
        <div className="flex flex-col justify-between w-full h-auto lgl:flex-row">
          ...
          <div className="w-full lgl:w-[60%] h-full py-10 bg-gradient-to-r from-[#1e2024] to-[#23272b] flex flex-col gap-8 p-4 lgl:p-8 rounded-lg shadow-shadowOne">
            <form className="flex flex-col w-full gap-4 py-2 lgl:gap-6 lgl:py-5" ref={form} onSubmit={sendEmail} >
              {errMsg && (
              ...
              <div className="flex flex-col w-full gap-10 lgl:flex-row">
                <div className="flex flex-col w-full gap-4 lgl:w-1/2">
                  ...
                  <input type="hidden" name="to_name" value={'Azedine'}/>
                  <input
